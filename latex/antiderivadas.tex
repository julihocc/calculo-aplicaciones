...
\end{figure}
 ...
 \subsection{Ejemplos Resueltos}
  ...
  \begin{resuelto}[F\'ormula de integración por sustitución \eqref{regla:8}]
   \begin{enumerate}
...
%\begin{resuelto}[Antiderivadas] En los siguientes Ejemplos, puede utilizar cualquier regla para antiderivadas.
%\begin{multicols}{2}
% \begin{enumerate}
